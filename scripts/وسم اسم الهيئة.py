...
def extract_specific_records(input_file):
    ...
    new_pattern = r'^\w{3,4}\،\ .*\،\ اسْمُ هَيْئَة$'
    ...
    specific_word_patterns = [
                ...
                r'إ[ِ]?[آؤءئأا-ي][ْ]?[آؤءئأا-ي][َ]?ة',
                r'إ[ِ]?[آؤءئأا-ي][ّ]?[َ]?ة',
                r'[آءؤئأا-ي][ِ][ي][آءؤئأا-ي][َ]ة'
    ]
...
intro_sentence = "-------------------------خطأ في وسم اسم الهيئة--------------------------\n\n"

# حفظ النتائج في ملف جديد
with open("خطأ في وسم اسم الهيئة.txt", 'w', encoding='utf-8') as f:
